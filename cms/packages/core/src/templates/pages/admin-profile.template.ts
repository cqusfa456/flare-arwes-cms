          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10">
            ...
            <form id="profile-form" hx-put="/admin/profile" hx-target="#form-messages" class="p-6 space-y-6">
              ...
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label for="timezone" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('Timezone')}</label>
                  ...
                  <div>
                    <label for="language" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('Language')}</label>
                    <div class="grid grid-cols-1">
              ...
              <!-- Notifications -->
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('Notifications')}</h3>
                ...
                <div class="space-y-5">
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="email_notifications" class="font-medium text-zinc-950 dark:text-white">${t('Email notifications')}</label>
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            ...
            <dl class="space-y-3 text-sm">
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('Role')}</dt>
                <dd class="mt-1">
          ...
          <!-- Security Actions -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('Security')}</h3>
