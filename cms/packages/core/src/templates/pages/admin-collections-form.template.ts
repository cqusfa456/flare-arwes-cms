        ...
        <div class="px-6 py-6">
          ...
          ${isEdit && data.managed ? `
            ...
            <div class="mt-8 pt-8 border-t border-zinc-950/5 dark:border-white/10">
              <div class="mb-6">
                <h3 class="text-base/7 font-semibold text-zinc-950 dark:text-white">${t('Collection Fields')}</h3>
              ...
              <div class="space-y-3">
                ...
                ${(data.fields || []).length === 0 ? `
                  <div class="text-center py-12 text-zinc-500 dark:text-zinc-400">
                    ...
                    <p class="mt-4 text-base/7 font-semibold text-zinc-950 dark:text-white">${t('No fields defined')}</p>
    ...
    <div id="field-modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 hidden">
      <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-xl ring-1 ring-zinc-950/5 dark:ring-white/10 w-full max-w-lg mx-4">
        <div class="px-6 py-4 border-b border-zinc-950/5 dark:border-white/10">
          <div class="flex items-center justify-between">
            <h3 id="modal-title" class="text-lg font-semibold text-zinc-950 dark:text-white">${t('Add Field')}</h3>
        ...
        <form id="field-form" class="p-6 space-y-4">
          ...
          <div>
            <label for="field-type" class="block text-sm/6 font-medium text-zinc-950 dark:text-white">${t('Field Type')}</label>
          ...
          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('Field Label')}</label>
            <input
              type="text"
              id="field-label"
              name="field_label"
          ...
          <div class="flex items-center space-x-6">
            <div class="flex gap-3">
              ...
              <div class="text-sm/6">
                <label for="field-required" class="font-medium text-zinc-950 dark:text-white">${t('Required')}</label>
              </div>
            </div>
          ...
          <div class="flex justify-end space-x-3 pt-4 border-t border-zinc-950/5 dark:border-white/10">
            ...
            >
              <span id="submit-text">${t('Add Field')}</span>
            </button>
          </div>
        </form>
      </div>
