          ...
          <div class="px-6 py-5">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4 flex-1">
                ...
                <div>
                  <label for="language" class="block text-sm/6 font-mediu>${t('Language')}<c-950 dark:text-white">Language</label>
                  <div class="mt-2 grid grid-cols-1">
                    <select
                      name="language"
                      id="language"
                ...
                <div class="flex-1 max-w-md">
                  <label for="search" class="block text-sm font-me>${t('Search')}<t-zinc-950 dark:text-white mb-2">Search</label>
