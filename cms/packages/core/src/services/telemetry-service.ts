 ...
 * Telemetry Service
 *
 * Privacy-first telemetry service using custom Sci-Fi CMS stats endpoint
 * - No PII collection
 * - Opt-out by default
...
export class TelemetryService {
  ...
  async track(event: TelemetryEvent, properties?: TelemetryProperties): Promise<void> {
    ...
    try {
      ...
      // Send to custom Sci-Fi CMS stats endpoint
