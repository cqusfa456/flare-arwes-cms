...
CAPTCHA-free bot protection using Cloudflare Turnstile. Provides reusable verification middleware for any form in your Sci-Fi CMS application.
...
The Turnstile plugin is a core plugin and is included by default in Sci-Fi CMS.
...
```typescript
import { renderInlineTurnstile } from '@sci-fi-cms/core/plugins'
...
```typescript
import { createTurnstileMiddleware } from '@sci-fi-cms/core/plugins'
...
```typescript
import { TurnstileService } from '@sci-fi-cms/core/plugins'
...
import { verifyTurnstile, renderInlineTurnstile } from '@sci-fi-cms/core/plugins'
