 ...
 * `@sci-fi-cms/core`, which supports R2, B2, AWS S3, MinIO and any other
 ...
 * New code should import `S3Storage` or `resolveStorage` from `@sci-fi-cms/core`.
 */

export { S3Storage as B2Storage } from '@sci-fi-cms/core'
export type { S3StorageOptions as B2StorageOptions } from '@sci-fi-cms/core'
export type {
